...
import com.hachathon.presentationHelper.databinding.ActivityWelcomeBinding
...
class WelcomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pwd = sharedPreferences.getString("PWD", null).toString()
    ...
    private fun autoLoginAPI(id: String, pwd: String) {
        // 서버 주소
                ...
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        if (loginResponse?.status == "success") {
                            ...
                            val mIntent = Intent(this@WelcomeActivity, MainActivity::class.java)
                            startActivity(mIntent)
                            finish()
                        }
                    } else {
